...
//	rIICADD  = 0x10;                    //2440 slave address = [7:1]
	rIICADD  = 0xA0;                    //2440 slave address = [7:1]
	rIICSTAT = 0x10;                    //IIC bus data output enable(Rx/Tx)
//	rIICLC = (1<<2)|(1<<0);  				// Filter enable, 15 clocks SDA output delay
	rIICLC = (0<<2);  				// Filter disable, 15 clocks SDA output delay
