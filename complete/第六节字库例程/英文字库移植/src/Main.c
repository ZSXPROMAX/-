...
//--------add end-----------------
	...
	Lcd_PutASCII(151,100,'z',0x0000,0x001f,1);
	Lcd_PutASCII(159,100,'h',0x0000,0x001f,1);
	Lcd_PutASCII(167,100,'a',0x0000,0x001f,1);
	Lcd_PutASCII(175,100,'n',0x0000,0x001f,1);
	Lcd_PutASCII(183,100,'g',0x0000,0x001f,1);	
	Lcd_PutASCII(191,100,'s',0x0000,0x001f,1);
	Lcd_PutASCII(191,100,'u',0x0000,0x001f,1);
	Lcd_PutASCII(191,100,'o',0x0000,0x001f,1);
	Lcd_PutASCII(191,100,'x',0x0000,0x001f,1);
	Lcd_PutASCII(191,100,'i',0x0000,0x001f,1);
	Lcd_PutASCII(191,100,'n',0x0000,0x001f,1);
	...
	Lcd_PutASCII(175,100,'n',0x0000,0x001f,1);
	Lcd_PutASCII(183,100,'g',0x0000,0x001f,1);
	Lcd_PutASCII(151,100,'h',0x0000,0x001f,1);
	Lcd_PutASCII(159,100,'a',0x0000,0x001f,1);
	Lcd_PutASCII(167,100,'i',0x0000,0x001f,1);
	Lcd_PutASCII(175,100,'m',0x0000,0x001f,1);
	Lcd_PutASCII(183,100,'e',0x0000,0x001f,1);
	Lcd_PutASCII(183,100,'n',0x0000,0x001f,1);
	Lcd_PutASCII(183,100,'g',0x0000,0x001f,1);
