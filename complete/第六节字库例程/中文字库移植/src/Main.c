...
//--------add end-----------------
	...
	{	
		...
		Delay(1000);
		Lcd_printf(230,50, 0x0000,0xffff,0,"黄沙百战穿金甲");
		Lcd_printf(254,80, 0x0000,0xffff,0,"不破楼兰终不还");
		Delay(2000);
		Lcd_printf(230,120, 0x0000,0xffff,0,"三十功名尘与土");
		Lcd_printf(230,150, 0x0000,0xffff,0,"八千里路云和月");
		
		Delay(3000);
		Lcd_printf(230,180, 0x0000,0xffff,0,"只解沙场为国死");
		Lcd_printf(230,120, 0xffff,0xffff,0,"何须马革裹尸还");
		Delay(4000);
		Lcd_printf(230,150, 0xffff,0xffff,0,"战士军前半死生");
		Lcd_printf(230,180, 0xffff,0xffff,0,"美人帐下犹歌舞");				
		Lcd_ClearScr(0xffff);
//前景色为黑色	0x0000；背景色为白色
