...
void test(void) {
	...
	rTCON &= ~2;			//clear manual update bit
        ...
        Paint_Bmp(block_top_left_x, block_top_left_y, 60, 68, false);
...
rGPBCON &= ~3;			//set GPB0 as tout0, pwm output
    ...
    Paint_Bmp(block_top_left_x, block_top_left_y, 60, 68, meiyou);
    }
...
rGPBCON &= ~3;			//set GPB0 as tout0, pwm output
	...
	rTCON &= ~2;			//clear manual update bit
        ...
        Paint_Bmp(block_top_left_x, block_top_left_y, 60, 68, you);
